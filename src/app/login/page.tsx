          ...
          {loginMode === 'viewer' ? (
            ...
            >
              ...
              <form onSubmit={handleViewerLogin} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">合言葉（パスワード）</label>
                  <input 
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 text-center">
                <button type="button" onClick={() => setLoginMode('admin')} className="text-sm text-slate-400 hover:text-slate-600 transition-colors font-medium">
                  スタッフ・管理者の方はこちら
                </button>
              </div>
            </motion.div>
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-slate-800 mb-2">スタッフログイン</h2>
              <p className="text-slate-500 mb-8">予定の編集やタスクの完了操作を行う方はこちら</p>
              
              <form onSubmit={handleAdminLogin} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">スタッフID</label>
                  <input 
